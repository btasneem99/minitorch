...
class Module:
    ...
    def named_parameters(self) -> Sequence[Tuple[str, Parameter]]:
        ...
        # loop over every module and its children
        # p: Dict[str, Module] = self.__dict__["_parameters"]
        # for key in p:
        #    return ((key , p[key]))
        ...
        #     master_param.append((key, par))

        # for module_name, mod in self._modules.items():
        #     little_param = mod.named_parameters()
        #     for param_name, child_param in little_param:
        #         master_param.append((f"{module_name}.{param_name}", child_param))

        # return master_param
        # add your children's parameters
